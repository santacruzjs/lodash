(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["RefluxPubSub"] = factory();
	else
		root["RefluxPubSub"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var topic2compsList = new Object();
	var comp2mappingList = new Object();

	var self = module.exports = {
	  registerComp: function(compId){
	    actions[compId] = Reflux.createAction();
	    stores[compId] = Reflux.createStore({
	      init: function(){
	        this.listenTo(actions[compId], this.compId);
	      },
	      compId: function(args){
	        this.trigger(args);
	      }
	    });
	    return Reflux.connect(stores[compId], 'store');
	  },
	  initPubSub: function(compId, topicNames, pubMap){
	    if(topicNames != undefined){
	      for(var i=0;i<topicNames.length;i++){
	        var topicName = topicNames[i];
	        if(topic2compsList[topicName] == undefined){
	          topic2compsList[topicName] = [];
	        }
	        if(topic2compsList[topicName].indexOf(compId) == -1)
	          topic2compsList[topicName].push(compId);
	      }
	    }
	    comp2mappingList[compId] = pubMap;
	  },
	  publishEvent: function(compId, eventName, args){
	    var event2topicMapping = comp2mappingList[compId];
	    var topicName = event2topicMapping[eventName];
	    var data = {topicName: topicName, eventName: eventName, args: args};
	    if(topic2compsList[topicName] == undefined){
	      return;
	    } else{
	      var compIds = topic2compsList[topicName];
	      for(var i=0;i<compIds.length;i++){
	        actions[compIds[i]](data);
	      }
	    }
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.PublisherMethods = __webpack_require__(16);

	Reflux.StoreMethods = __webpack_require__(15);

	Reflux.createAction = __webpack_require__(17);

	Reflux.createStore = __webpack_require__(11);

	var maker = __webpack_require__(10).staticJoinCreator;
	...
	Reflux.__keep = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(6),
	    maker = __webpack_require__(10).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(6),
	    Keep = __webpack_require__(12),
	    mixer = __webpack_require__(13),
	    bindMethods = __webpack_require__(14);
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(15),
	        PublisherMethods = __webpack_require__(16),
